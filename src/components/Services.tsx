...
function Services() {
  ...
  return (
    <div className="bg-banner-lower mb-0 pb-0">
            ...
            <div
              ...
              className={`flex-1 py-6 sm:py-8 md:py-10 lg:py-12 px-3 sm:px-4 md:px-5 lg:px-6 flex flex-col items-center justify-center ${
                index !== services.length - 1
                  ? 'md:border-r md:border-b-0 border-b md:border-t-0 border-cream'
                  : ''
              }`}
            >
              <div className="mb-3 sm:mb-4">
                <img
                  src={service.icon}
                  className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7 invert"
                />
              </div>
              <h3 className="font-rubik text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-black mb-1 sm:mb-2 text-center">
                {service.title}
              </h3>
              <p className="font-raleway text-xs sm:text-xs md:text-sm text-gray-800 font-light leading-relaxed text-center">
                {service.description}
              </p>
            </div>
          ))}
