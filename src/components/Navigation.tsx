...
function Navigation() {
  ...
  const shopItems = [
    ...
    { name: 'clothing', href: '/new-arrivals' },
    { name: 'Activities & Toys', href: '/bestsellers' },
    { name: 'Feeding & Nursing', href: '/sale' },
    { name: 'Bath Time', href: '/sale' },
    { name: 'Gear', href: '/sale' },
    { name: 'Gift', href: '/sale' },
    { name: 'Maternity', href: '/sale' },
    { name: 'Nursing Favourite', href: '/sale' },
    { name: 'Sale', href: '/sale' }
  ]
  ...
  return (
    <nav className="hidden flex-1 items-center justify-start gap-8 lg:flex">
      ...
      >
        ...
        <div
          className={`absolute left-0 top-full z-50 mt-2 w-48 rounded-sm bg-cream shadow-lg transition-all duration-300 ${
            activeDropdown === 'shop'
      ...
      >
        ...
        <div
          className={`absolute left-0 top-full z-50 mt-2 w-[1200px] rounded-sm bg-cream shadow-lg transition-all duration-300 ${
