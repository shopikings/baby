    ...
    <section className="bg-cream py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 sm:mb-12">
          <h2 className="text-start uppercase font-rubik text-2xl font-bold text-text-primary sm:text-3xl md:text-4xl lg:text-5xl">
            Shop the Look
          </h2>
          <p className="font-raleway mt-1 text-lg text-text-primary/70 sm:text-xl">
