  ...
  return (
    <div className="min-h-screen bg-cream py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="mb-8 font-rubik text-3xl font-normal text-text-primary sm:text-4xl lg:text-5xl">
            Terms of Service
          </h1>
        </div>
          ...
          <section>
            <div className="mb-8">
              ...
              <p className="mb-6 font-raleway text-base font-normal leading-relaxed text-text-primary/80">
                This website is operated by maison baby and kids. Throughout the
                site, the terms &quot;we&quot;, &quot;us&quot; and
                &quot;our&quot; refer to maison baby and kids. Maison baby and
                kids offers this website, including all information, tools and
              ...
              <p className="mb-6 font-raleway text-base font-normal leading-relaxed text-text-primary/80">
                ...
                part of these Terms of Service by posting updates and/ or
            ...
            <div className="mb-8">
              ...
              <p className="mb-6 font-raleway text-base font-normal leading-relaxed text-text-primary/80">
                ...
                disparage, intimidate, or discriminate based on gender, intimate
                ...
                website, or the Internet; (h) to collect or track the personal
            ...
            <div className="mb-8">
              ...
              <p className="mb-6 font-raleway text-base font-normal leading-relaxed text-text-primary/80">
                You agree to indemnify, defend and hold harmless All Things
                Dylan and our parent, subsidiaries, affiliates, partners,
